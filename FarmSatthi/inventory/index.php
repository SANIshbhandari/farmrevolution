...
$item_type = sanitizeInput($_GET['item_type'] ?? '');
    ...
    <form method="GET" action="index.php" class="filters-form">
        <div class="filter-group">
            <select name="item_type" class="form-control">
                ...
                <option value="supply" <?php echo $item_type === 'supply' ? 'selected' : ''; ?>>Supplies</option>
                <option value="equipment" <?php echo $item_type === 'equipment' ? 'selected' : ''; ?>>Equipment</option>
                <option value="employee" <?php echo $item_type === 'employee' ? 'selected' : ''; ?>>Employees</option>
            </select>
        </div>
        <div class="filter-group">
            <input 
